...
const MOMAY_SERVER = (import.meta.env.VITE_MOMAY_SERVER || 'https://momaybuu-production.up.railway.app').replace(/\/$/, '')
...
export default function CheckIn() {
  ...
  useEffect(() => {
    ...
    fetch(`${MOMAY_SERVER}/api/bookings/${encodeURIComponent(id)}/checkin`, { method: 'POST' })
      .then(r => r.json())
      .then(j => {
